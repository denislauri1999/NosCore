...
namespace NosCore.GameObject.Tests.Services.BattleService
{
    ...
    public class HitQueueTests
    {
        ...
        public async Task LandedHitAppliesSkillBuffsWhenSkillHasDuration()
        {
            ...
            var queue = new HitQueue(calc.Object, stats.Object, buffs.Object, new Mock<IRegenerationService>().Object, new Mock<IInflictedCardService>().Object, new Mock<ILogger<HitQueue>>().Object);
